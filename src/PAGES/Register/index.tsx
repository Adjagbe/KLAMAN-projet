...
function Register() {
  return (
    <>
        ...
        <div className='text-xl flex flex-col space-y-2 pl-20 my-10'>
              <span className='font-bold'><u>Hôtesse VIP</u></span>
        ...
        <div className='text-xl flex flex-col space-y-2 pl-20'>
              <span className='font-bold'><u>MODELE PHOTOS</u></span>
            ...
            <form>
                  ...
                  <div className='flex  mx-52 space-x-28 my-10'>
                    ...
                    <div className='flex flex-col space-y-2'>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Adjamé</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Abobo</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Anyama</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Attécoubé</span></div>
                    </div>
                    <div className='flex flex-col space-y-2'>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Bingerville</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Cocody</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Koumassi</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Macory</span></div>
                    </div>
                    <div className='flex flex-col space-y-2'>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Plataeu</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Port-Bouet</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Treichville</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Songon</span></div>
                    </div>
                    <div className='flex flex-col space-y-2'>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Yopougon</span></div>
                          <div className='flex space-x-2'> <input type="radio" /> <span>Autres</span></div>
                    </div>
                </div>
                  <div className='flex space-x-20 mx-52 my-10'>
